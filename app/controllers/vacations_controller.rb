class VacationsController < ApplicationController
  ...
  private
    ...
    def vacation_params
      params.require(:vacation).permit(:laborated_period, :end_of_laborated_period, :period_until_deductions, :business_days, :holidays, :entry_day, :exit_day, :last_vacations, :acumulated_periods, :suspension_days, :date_until_suspension, :cost_center, :status, :observations, :files)
    end
end
